  ...
  return (
    <div className="section help-section">
      <div className="help-title">
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 -960 960 960" style={{ height: '1rem', width: '1rem', fill: '#e3e3e3' }}>
      ...
      <div className="community-container">
        <div className="discord-panel">
          <div style={{ display: 'flex', marginBottom: '0.5rem' }}>
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" style={{ width: '1.125rem', height: '1.125rem', fill: '#5865F2' }}>
        ...
        <div className="website-panel">
          <div style={{ display: 'flex', marginBottom: '0.5rem' }}>
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 -960 960 960" style={{ width: '1.125rem', height: '1.125rem', fill: '#69f74c' }}>
