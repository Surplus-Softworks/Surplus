  ...
  return (
    <div className="section" style={styles.section}>
      ...
      <div style={styles.sectionTitle}>
        ...
        <div style={styles.sectionTitleContainer}>X-Ray</div>
        <Checkbox
          id="xray"
          label="Enabled"
      ...
      <div style={styles.sectionTitle}>
        ...
        <div style={styles.sectionTitleContainer}>ESP</div>
        <Checkbox
          id="esp-enable"
          label="Enabled"
      ...
      <div style={styles.group}>
        ...
        <div style={styles.sectionTitle}>Flashlights</div>
        <div style={styles.subgroup}>
          <Checkbox
            id="own-flashlight"
            label="Own"
      ...
      <div style={styles.sectionTitle}>
        ...
        <div style={styles.sectionTitleContainer}>Infinite Zoom</div>
        <KeybindSlot keybind="Shift" style={{ width: '38px' }} />
        <KeybindSlot keybind="Scroll" style={{ width: '38px' }} />
        <Checkbox
